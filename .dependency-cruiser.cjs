  ...
  from: {
   ...
   pathNot: [
    ...
    '(^|/)(?:babel|webpack)[.]config[.](?:js|cjs|mjs|ts|cts|mts|json)$', // other configs
        '(^|/)app/.*page[.](t|j)sx?$', // ✅ ignore Next.js pages
        '(^|/)app/.*layout[.](t|j)sx?$', // ✅ ignore Next.js layouts
        '(^|/)app/.*loading[.](t|j)sx?$', // ✅ ignore loading files
        '(^|/)app/.*error[.](t|j)sx?$' // ✅ ignore error boundaries
   ],
  },
  to: {},
 },
		...
		},
		{
			...
			to: {
				pathNot: [
					'^node_modules/[^/]+/effect',
					'^src/libraries/ddd',
					'^src/features/$1/domain/abilities/$2',
				],
			},
		},
		{
