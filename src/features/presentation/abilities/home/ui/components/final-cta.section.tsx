...
export const FinalCTASection = ({ className }: { className?: string }) => (
  <section id='final-cta' className={cn('my-24', className)}>
    <div className='text-center bg-primary-surface py-20 sm:px-16 px-8 rounded-xl md:text-xl text-lg'>
      ...
      <p className='pb-4'>
        Ouvert et disponible, je suis ravi d’échanger sur votre projet,
        <br />
        que vous ayez un besoin précis ou que vous soyez encore en phase de réflexion.
      </p>
      <p className='pb-8'>
        Contactez-moi, je vous réponds au plus vite et nous étudierons la meilleure manière de faire évoluer votre produit.
      </p>
